...
//        rules.add(new InvalidVietnameseRule());
//        
//        Scanner scanner = new Scanner(System.in);
//        System.out.println("Your Vietnamese string: ");
//        String target = scanner.nextLine();
//        
//        boolean result = false;
//        
//        for (Rule rule : rules) {
//            if ( rule.checkInvalidate(target) ) {
//                result = true;
//                break;
//            }
//        }
//        
//        System.out.println("Result: " + (result == true ? "Incorrect Spelling" : "Correc Spelling"));
